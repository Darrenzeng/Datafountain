...
from transformers import BertTokenizer, AdamW, Adafactor, BertModel, BertPreTrainedModel, BertConfig, \
...
class Config:
    def __init__(self):
        ...
        self.model_path = '/home/zyf/Summer_game2021/Datafountain/liu_nezha-pytorch/pretrain/nezha_output/mlm5/checkpoint-313000-epoch-500/'
...
#         pass
    ...
    best_val_loss = 0
    best_epoch = -1
    PATH = '/home/zyf/Summer_game2021/Datafountain/liu_nezha-pytorch/finetuning/model_test2/bert_{}.pth'.format(fold)
    # path ='/home/zyf/Summer_game2021/Datafountain/liu_nezha-pytorch/finetuning/models_mlm0.5/model_mlm5_param_{}.pkl'.format(fold)
    save_model_path = './model_test2/'
...
#                 torch.save(model.state_dict(), path)
        print("fold [{}/{}] train_loss={} val_loss={} train_f1={} val_f1={} dropout={} bs={}".format(fold +
              1, config.k_fold, np.mean(loss_num),np.mean(val_loss), np.mean(score), val_f1, config.dropout, config.batch_size))
        print("best_epoch:{}, best_val_loss:{}, best_val_f1:{}".format(best_epoch, best_val_loss, best_f1))
    optimizer.zero_grad()
